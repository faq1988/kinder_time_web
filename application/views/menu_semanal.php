<div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom"><i class="fa fa-cutlery"></i> Menú semanal</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
                       ...
                       <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center" >
                                        ...
                                        <div class="list-group list-group-horizontal" style="display: inline-block">
                                            <a href="<?=base_url()?>Welcome/crear_menu_semanal" class="list-group-item active btn" style="display: inline-block"><i class="fa fa-fw fa-plus"></i> Crear</a>                                                                                                               
                                        </div>
