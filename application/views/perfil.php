<div class="content-inner">
          ...
          <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom"><i class="fa fa-commenting-o"></i> Perfil</h2>
            </div>
          </header>
          <!-- Breadcrumb-->
                  ...
                  <div class="client card">
                    ...
                    <div class="card-body text-center">
                      ...
                      <div class="client-info">
                        <div class="row">
                          <div class="col-4"><strong>Luis Agote 5223</strong><br><small>Dirección</small></div>
                          <div class="col-4"><strong>0291-154391353</strong><br><small>Teléfono</small></div>
                          <div class="col-4"><strong>facu_carignano@hotmail.com</strong><br><small>Correo electrónico</small></div>
                        </div>
                      </div>
